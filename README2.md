...
`yt-dlp`コマンドはいくつかのオプションを受け取ることができますが、最高画質・最高音質のものを入手しようとすると、コマンドが長くなりすぎて使いづらいです。そこで、最高音質で音声のみダウンロードする、あるいは最高画質で動画をダウンロードする場合に便利なように、エイリアスを設定します。`~/.zshrc`に、以下をコピペしてください。
